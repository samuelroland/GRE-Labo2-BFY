...
/**
 * Immutable directed graph with integer weighted edges. Negative weights are
 * allowed. Instances can be multigraphs,
 * as such, there can be multiple edges for the same ordered pair of vertices,
 * as well as self-loops.
 * <p>
 * Vertices are indexed from 0 to n-1, where n is the number of vertices in the
 * graph.
 * <p>
...
public final class WeightedDigraph {
     ...
     * Digraph builder
     * <p>
     * Number of vertices must be specified at construction. Edges are added using
    ...
    /**
     * Returns an immutable list of unsorted outgoing edges for the given vertex.
     ...
     * @throws IndexOutOfBoundsException if {@code vertex} is < 0 or >= number of
     *                                   vertices.
     */
